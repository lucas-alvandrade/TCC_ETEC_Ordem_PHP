            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_add">                    
                    ...
                    <fieldset class="mt-4 border p-2 mb-3">
                        ...
                        <legend class="font-small"><i class="fas fa-credit-card"></i>&nbsp;Dados da forma de pagamento</legend>
                    ...
                    <a title="Voltar" href="<?php echo base_url('modulo'); ?>" class="btn btn-success btn-sm ml-2">Voltar</i></a>
                </form>
            </div>
        </div>
