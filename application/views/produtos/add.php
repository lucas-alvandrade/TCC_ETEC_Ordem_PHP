            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_add">                    
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <legend class="font-small"><i class="fas fa-boxes"></i>&nbsp;Dados principais</legend>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label>Unidade</label>
                                <input type="text" class="form-control form-control-user" name="produto_unidade" placeholder="Ex: un, cx, m, kg..." value="<?php echo set_value('produto_unidade') ?>">
                    ...
                    <a title="Voltar" href="<?php echo base_url($this->router->fetch_class()); ?>" class="btn btn-success btn-sm ml-2">Voltar</i></a>
                </form>
            </div>
        </div>
