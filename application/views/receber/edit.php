            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <legend class="font-small"><i class="fas fa-money-check-alt"></i>&nbsp;Dados da conta</legend>                        
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" <?php echo ($conta_receber->conta_receber_status == 1 ? 'disabled' : '') ?>>Salvar</button>
