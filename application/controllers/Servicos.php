...
//definindo regras para cada campo do formulário
        ...
        $this->form_validation->set_rules('servico_nome', '', 'trim|required|is_unique[servicos.servico_nome]');
...
//definindo regras para cada campo do formulário
            ...
            $this->form_validation->set_rules('servico_nome', '', 'trim|required|min_length[5]|max_length[145]|callback_check_nome_servico');
            $this->form_validation->set_rules('servico_preco', '', 'trim|required');
            $this->form_validation->set_rules('servico_descricao', '', 'trim|required|max_length[500]');
