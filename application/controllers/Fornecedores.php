...
//            exit();
                ...
                /*
                  [fornecedor_id] => 1
                  [fornecedor_data_cadastro] => 2021-07-19 12:17:37
                  [fornecedor_razao] => Geralt Componentes LTDA
                  [fornecedor_nome_fantasia] => Nanotech Inc
                  [fornecedor_cnpj] => 74.238.680/0001-12
                  [fornecedor_ie] =>
                  [fornecedor_telefone] =>
                  [fornecedor_celular] =>
                  [fornecedor_email] => contato@nanotech.com
                  [fornecedor_contato] => Vesemir
                  [fornecedor_cep] =>
                  [fornecedor_endereco] =>
                  [fornecedor_numero_endereco] =>
                  [fornecedor_bairro] =>
                  ...
                  [fornecedor_ativo] => 1
                  [fornecedor_obs] =>
                  [fornecedor_data_alteracao] => 2021-07-19 12:17:37
                 */
    ...
    public function check_fornecedor_email($fornecedor_email) {
        ...
        if ($this->core_model->get_by_id('fornecedores', array('fornecedor_email' => $fornecedor_email, 'fornecedor_id !=' => $fornecedor_id))) {
            $this->form_validation->set_message('check_fornecedor_email', 'Esse email já existe');
            return FALSE;
        } else {
            return TRUE;
        }
