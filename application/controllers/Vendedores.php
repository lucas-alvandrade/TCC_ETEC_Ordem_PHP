...
//definindo regras para cada campo do formulário
        $this->form_validation->set_rules('vendedor_nome_completo', '', 'trim|required|min_length[2]|max_length[200]');
        ...
        if ($this->form_validation->run()) {
            ...
            $data = array(
                ...
                //Gera um valor de matricula aleatório de 8 digitos
...
//            exit();
    ...
    public function check_vendedor_email($vendedor_email) {
        ...
        if ($this->core_model->get_by_id('vendedores', array('vendedor_email' => $vendedor_email, 'vendedor_id !=' => $vendedor_id))) {
            $this->form_validation->set_message('check_vendedor_email', 'Esse email já existe');
            return FALSE;
        } else {
            return TRUE;
        }
